...
* Tìm hiểu tổng quan và ứng dụng thực tế của Amazon EC2.
* Nắm được các thành phần quan trọng của EC2 như Key Pair, Security Group, Elastic IP, User Data và Amazon EBS.
* Thực hành tạo và kết nối EC2 trong môi trường VPC.
* Thực hành quản lý lưu trữ với Amazon EBS.
* Hoàn thành các bài Lab EC2 và chuẩn hóa kiến thức nền tảng.
...
* Hiểu tổng quan về Amazon EC2, các use case phổ biến và các loại instance cơ bản.
* Nắm được vai trò của Key Pair, Security Group, Elastic IP, User Data và Amazon EBS trong quá trình triển khai EC2.
* Tạo và cấu hình được EC2 Instance trong VPC với các thiết lập mạng và bảo mật phù hợp.
* Thực hiện được các phương thức kết nối EC2 bằng EC2 Instance Connect và SSH Client.
* Tạo, gắn và quản lý được Amazon EBS Volume cho EC2 Instance.
* Hoàn thành các bài Lab EC2 và EBS, sẵn sàng triển khai các nội dung AWS tiếp theo.
