...
* Learn Amazon S3, AWS Lambda, and Amazon RDS.
* Practice object storage, serverless computing, and relational databases on AWS.
* Review the foundational AWS services learned so far to prepare for the project development phase.
...
* Understood how to store data with Amazon S3.
* Learned how to create and manage Buckets and Objects.
* Understood the Serverless model and how to use AWS Lambda.
* Understood the basics of Amazon RDS and how to deploy a database on AWS.
* Completed the foundational AWS learning phase and was ready to enter the **4-week project development phase**.
