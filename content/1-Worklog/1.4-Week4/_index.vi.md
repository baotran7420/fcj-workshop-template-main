...
* Tìm hiểu Amazon S3, AWS Lambda và Amazon RDS.
* Thực hành lưu trữ đối tượng, serverless computing và cơ sở dữ liệu quan hệ trên AWS.
* Ôn lại các dịch vụ AWS nền tảng đã học để chuẩn bị bước sang giai đoạn phát triển dự án.
...
* Hiểu cách lưu trữ dữ liệu với Amazon S3.
* Biết tạo và quản lý Bucket, Object.
* Hiểu mô hình Serverless và sử dụng AWS Lambda.
* Hiểu cơ bản về Amazon RDS và cách triển khai cơ sở dữ liệu trên AWS.
* Hoàn thành giai đoạn học các dịch vụ AWS nền tảng để sẵn sàng bước sang **4 tuần phát triển dự án**.
