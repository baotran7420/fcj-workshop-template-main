...
* Get acquainted with the FCAJ members.
* Read and note the internship unit rules and regulations.
* Learn the fundamentals of AWS Cloud, IAM, CLI, and basic VPC concepts.
* Build a foundation for AWS hands-on practice starting from Week 2.
...
* Understood the Cloud Computing model and AWS global infrastructure.
* Understood the roles of the main AWS service groups.
* Understood identity and access management with IAM.
* Understood the basic network architecture of Amazon VPC and the role of components such as Subnet, Route Table, Internet Gateway, NAT Gateway, Security Group, and Network ACL.
* Built a foundation to start AWS hands-on practice from Week 2.
