...
* Làm quen với các thành viên FCAJ.
* Đọc và lưu ý các nội quy, quy định tại đơn vị thực tập.
* Tìm hiểu tổng quan về AWS Cloud, IAM, CLI và VPC cơ bản.
* Chuẩn bị nền tảng để bắt đầu thực hành AWS từ tuần 2.
...
* Hiểu mô hình Cloud Computing và hạ tầng toàn cầu của AWS.
* Nắm được chức năng của các nhóm dịch vụ chính trên AWS.
* Hiểu cơ chế quản lý danh tính và phân quyền với IAM.
* Hiểu kiến trúc mạng cơ bản của Amazon VPC và vai trò của các thành phần như Subnet, Route Table, Internet Gateway, NAT Gateway, Security Group và Network ACL.
* Chuẩn bị nền tảng để **bắt đầu thực hành AWS từ tuần 2**.
