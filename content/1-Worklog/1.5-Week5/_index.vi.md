...
* Tìm hiểu các dịch vụ AWS phục vụ phát triển ứng dụng theo mô hình Serverless.
* Nắm được cách giám sát và theo dõi tài nguyên trên AWS.
* Hoàn thành giai đoạn học các dịch vụ AWS trước khi bắt đầu triển khai dự án.
...
* Hiểu mô hình Serverless Computing và cách triển khai AWS Lambda.
* Tạo và kiểm thử được Lambda Function cơ bản.
* Hiểu cách giám sát tài nguyên với Amazon CloudWatch.
* Theo dõi được các hoạt động trên tài khoản AWS bằng AWS CloudTrail.
* Hoàn thành giai đoạn học các dịch vụ AWS nền tảng và sẵn sàng bước sang giai đoạn phát triển dự án.
