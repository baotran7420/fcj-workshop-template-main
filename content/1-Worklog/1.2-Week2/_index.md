...
* Learn AWS CLI fundamentals and basic billing tools.
* Practice core Amazon VPC concepts and components.
* Review IAM, AWS CLI, and VPC to prepare for Amazon EC2 in Week 3.
...
* Used an IAM User instead of the Root User.
* Learned how to configure and use AWS CLI.
* Created and configured a basic Amazon VPC.
* Understood how VPC, Subnet, Internet Gateway, Route Table, Security Group, and Network ACL work together.
* Was ready to move on to Amazon EC2 in Week 3.
